...
func TestHarden(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			abstract: abstractConfig{
				"comp1": map[string]any{"kind": "mock", "spec": map[string]any{}},
				"comp2": map[string]any{"kind": "mock", "spec": map[string]any{}},
			},
			expectedProviders: 1,
			expectedTotal:     2,
		},
		{
			...
			abstract: abstractConfig{
				"a": map[string]any{"kind": "mock", "spec": map[string]any{}},
				"b": map[string]any{"kind": "mock", "spec": map[string]any{}},
			},
			expectedProviders: 1,
			expectedTotal:     2,
		},
		{
			...
			abstract: abstractConfig{
				"test": map[string]any{"kind": "nonexistent", "spec": map[string]any{}},
			},
			expectedProviders: 0,
			expectedTotal:     0,
		},
...
func TestHardenSetName(t *testing.T) {
	abstract := abstractConfig{
		"myinstance": map[string]any{"kind": "mock", "spec": map[string]any{}},
	}
...
func TestUnknownComponentKeysFixtures(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:             "Missing required key 'kind' in strict mode",
			configFile:       "missing_kind",
			strict:           true,
			expectErrors:     1,
			expectInstances:  0,
		},
		{
			name:             "Missing required key 'kind' in non-strict mode",
			configFile:       "missing_kind",
			strict:           false,
