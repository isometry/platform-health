...
func TestSystemGetHealth(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assert.Equal(t, system.ProviderKind, result.GetKind())
...
func TestSystemUnknownProviderReturnsError(t *testing.T) {
	...
	assert.Contains(t, s.ComponentErrors()[0].Error(), "unknown provider kind")
...
func TestSystemNestedSystems(t *testing.T) {
	...
	assert.Equal(t, system.ProviderKind, inner.GetKind())
	...
	assert.Equal(t, mock.ProviderKind, leaf.GetKind())
...
func TestSystemInterface(t *testing.T) {
	...
	assert.Equal(t, system.ProviderKind, s.GetKind())
