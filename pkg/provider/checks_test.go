...
func (m *mockCheckProvider) GetKind() string { return "mock" }
...
func (m *mockNonCheckProvider) GetKind() string { return "nonce" }
...
func (t *testableCheckProvider) GetKind() string { return "testable" }
